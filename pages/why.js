        ...
        <div className="w-full flex flex-col md:flex-row px-0 md:px-10 lg:px-20 items-center md:items-start">
          <div className="order-last flex mx-auto flex-col w-full md:w-[40%] lg:w-[35%] max-w-[34.375rem] md:max-w-full max-h-[full] z-10">
              <div className="w-full mx-auto md:mt-[-10px]">
                <blockquote className="twitter-tweet" data-theme="dark"><p lang="en" dir="ltr">Building in public is such a cool thing to witness. Check out this episode of Your First Million with <a href="https://twitter.com/ArlanWasHere?ref_src=twsrc%5Etfw">@ArlanWasHere</a> about the first month of <a href="https://twitter.com/hirerunner?ref_src=twsrc%5Etfw">@hirerunner</a> . She is doing big things here. <a href="https://t.co/cg6TPOReC3">https://t.co/cg6TPOReC3</a></p>&mdash; Karen Hebert-Maccaro ☕️ (@eduversequeen) <a href="https://twitter.com/eduversequeen/status/1449414258857586692?ref_src=twsrc%5Etfw">October 16, 2021</a></blockquote>
              </div>
              <div>
                <blockquote className="twitter-tweet" data-conversation="none" data-theme="dark"><p lang="en" dir="ltr">The W2 + Benefits is so crucial. Kudos.</p>&mdash; Racquel Simone (@racquelsimone_) <a href="https://twitter.com/racquelsimone_/status/1449410610538577921?ref_src=twsrc%5Etfw">October 16, 2021</a></blockquote>
              </div>
              <div>
                <blockquote className="twitter-tweet" data-theme="dark"><p lang="en" dir="ltr">Did you know? Runners (EAs, COOs, HR/People Ops leads, etc) who work w/our customers are offered W2 employment by <a href="https://twitter.com/hirerunner?ref_src=twsrc%5Etfw">@hirerunner</a> with access to benefits like health, dental, vision, 401k, paid days off, ownership, and more! Let’s GO!<br/><br/>Hire &amp; get hired: <a href="https://t.co/dAuCO6ETF1">https://t.co/dAuCO6ETF1</a></p>&mdash; HireRunner🏃🏾‍♀️ (@hirerunner) <a href="https://twitter.com/hirerunner/status/1448294919773163521?ref_src=twsrc%5Etfw">October 13, 2021</a></blockquote>
              </div>
              <div>
